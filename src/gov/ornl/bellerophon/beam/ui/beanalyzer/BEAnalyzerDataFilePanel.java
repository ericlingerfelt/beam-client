...
public class BEAnalyzerDataFilePanel extends JPanel implements ActionListener, 
																	GetMeanSpectrogramListener, 
																	DownloadDataFileListener, 
																	CustomFileChangeListener, GetDataFileTreeListener{
	...
	public BEAnalyzerDataFilePanel(Frame frame, BEAnalyzerData d, DataFileSelectionListener dfsl){
		...
		selectLabel.setText("Please select a data file from your BEAM data storage area or upload a new data file to your"
				+ " BEAM data storage area for BE analysis.");
