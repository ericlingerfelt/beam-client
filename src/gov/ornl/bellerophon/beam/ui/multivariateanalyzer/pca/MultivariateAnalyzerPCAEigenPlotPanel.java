...
public class MultivariateAnalyzerPCAEigenPlotPanel extends JPanel implements MouseMotionListener, MouseListener{
	...
	public MultivariateAnalyzerPCAEigenPlotPanel(int index){
		this.index = index;
	...
	public void setCurrentData(double[] valueArray){

		this.valueArray = valueArray;
		
		titleString = "";
		xtitle = "Spectral Index";
		ytitle = "Variance";
		
		int size = 1;
		imax = size;
		kmax = valueArray.length;
