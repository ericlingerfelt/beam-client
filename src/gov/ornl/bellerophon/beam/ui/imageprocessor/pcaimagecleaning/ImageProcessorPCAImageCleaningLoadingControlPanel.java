...
public class ImageProcessorPCAImageCleaningLoadingControlPanel extends JPanel implements ActionListener, ChangeListener{
	...
	private JTextField pcField, xField, yField, valueField;
	private JComboBox<ColorMapType> colorMapBox;
	private ImageProcessorPCAImageCleaningLoadingControlPanelListener listener;
	
	public ImageProcessorPCAImageCleaningLoadingControlPanel(ImageProcessorPCAImageCleaningLoadingControlPanelListener listener){
		...
		buttonPanelValues.add(pcLabel, 			"1, 1, r, c");
		buttonPanelValues.add(pcField, 			"3, 1, f, c");
		buttonPanelValues.add(xLabel, 			"1, 3, r, c");
		buttonPanelValues.add(xField, 			"3, 3, f, c");
		buttonPanelValues.add(yLabel, 			"1, 5, r, c");
		buttonPanelValues.add(yField, 			"3, 5, f, c");
		buttonPanelValues.add(valueLabel, 		"1, 7, r, c");
		buttonPanelValues.add(valueField, 		"3, 7, f, c");
		buttonPanelValues.add(showCrossHairsBox,"1, 9, 3, 9, c, c");
	...
	public void setValues(String pc, String x, String y, String value){
		pcField.setText(pc);
		xField.setText(x);
		yField.setText(y);
	...
	public void stateChanged(ChangeEvent ce) {
		if(ce.getSource()==zoomSpinner
			...
			listener.loadingControlPanelStateChanged();
		}
	}
