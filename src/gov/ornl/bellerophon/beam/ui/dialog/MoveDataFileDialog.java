...
public class MoveDataFileDialog extends JDialog implements ActionListener, RemoteDirTreeListener{
	...
	public MoveDataFileDialog(Window owner, CustomFile customFile){
		this(owner, customFile, null);
	}
	
	public MoveDataFileDialog(Window owner, CustomFile customFile, CustomFile rootDirFile){
		
		super(owner, "Move Data File", Dialog.ModalityType.APPLICATION_MODAL);
		...
		topLabel.setText("Please select a new parent directory for the " + customFile.getFullPath() + " data file and click <i>Submit</i>.");
	...
	public static CustomFile createMoveDataFileDialog(Frame owner, CustomFile customFile, CustomFile rootDirFile){
		MoveDataFileDialog dialog = new MoveDataFileDialog(owner, customFile, rootDirFile);
		dialog.setVisible(true);
		return dialog.selectedCustomFile;
	}
	
	public static CustomFile createMoveDataFileDialog(Frame owner, CustomFile customFile){
		MoveDataFileDialog dialog = new MoveDataFileDialog(owner, customFile);
		dialog.setVisible(true);
		return dialog.selectedCustomFile;
	}
