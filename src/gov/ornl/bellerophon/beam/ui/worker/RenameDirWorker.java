...
public class RenameDirWorker extends SwingWorker<ErrorResult, Void>{

	private RenameDirListener rdl;
	 ...
	 * @param node the node
	 */
	public RenameDirWorker(RenameDirListener rdl
	...
	protected ErrorResult doInBackground(){
		...
		return WebServiceCom.getInstance().doWebServiceComCall(customFile, Action.RENAME_DIR);
	}
	...
	protected void done(){
		try{
			...
			if(!result.isError()){
				rdl.updateAfterRenameDir(customFile);
