...
public class ImageProcessorPCAImageCleaningSetViewPanel extends JPanel implements ActionListener, ChangeListener{
	...
	private ArrayList<ImageProcessorPCAImageCleaningSetViewPanelListener> listenerList;
	private int listenerIndex;
	private ImageProcessorData d;
	
	public ImageProcessorPCAImageCleaningSetViewPanel(ImageProcessorData d){
	...
	public void setImageProcessorPCAImageCleaningSetViewPanelListenerList(ArrayList<ImageProcessorPCAImageCleaningSetViewPanelListener> listenerList){
	...
	public void setCurrentState(){
		...
		int numPC = d.getDataFile().getPCAImageCleaningDataSet().getPCADataList().size();
